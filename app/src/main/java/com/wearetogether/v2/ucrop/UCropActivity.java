package com.wearetogether.v2.ucrop;
...
import com.wearetogether.v2.ucrop.callback.BitmapCropCallback;
import com.wearetogether.v2.ucrop.model.AspectRatio;
import com.wearetogether.v2.ucrop.util.SelectedStateListDrawable;
import com.wearetogether.v2.ucrop.view.*;
import com.wearetogether.v2.ucrop.view.widget.AspectRatioTextView;
import com.wearetogether.v2.ucrop.view.widget.HorizontalProgressWheelView;
...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setWidgetState(@IdRes int stateViewId) {
        ...
        mLayoutRotate.setVisibility(stateViewId == com.wearetogether.v2.R.id.state_rotate ? View.VISIBLE : View.GONE);
        mLayoutScale.setVisibility(stateViewId == com.wearetogether.v2.R.id.state_scale ? View.VISIBLE : View.GONE);

        if (stateViewId == com.wearetogether.v2.R.id.state_scale) {
            setAllowedGestures(0);
        } else if (stateViewId == com.wearetogether.v2.R.id.state_rotate) {
    ...
    private void addBlockingView() {
        if (mBlockingView == null) {
            ...
            lp.addRule(RelativeLayout.BELOW, com.wearetogether.v2.R.id.toolbar);
            mBlockingView.setLayoutParams(lp);
            mBlockingView.setClickable(true);
        }

        ((RelativeLayout) findViewById(com.wearetogether.v2.R.id.ucrop_photobox)).addView(mBlockingView);
    }
    ...
    protected void setResultUri(Uri uri, float resultAspectRatio, int offsetX, int offsetY, int imageWidth, int imageHeight) {
        long unic = getIntent().getLongExtra(Consts.UNIC, 0);
        long item_unic = getIntent().getLongExtra("item_unic", 0);
        int position = getIntent().getIntExtra(Consts.POSITION, 0);
        setResult(RESULT_OK, new Intent()
                .putExtra(UCrop.EXTRA_OUTPUT_URI, uri)
                .putExtra(Consts.UNIC, unic)
                .putExtra("item_unic", item_unic)
                .putExtra(Consts.POSITION, position)
